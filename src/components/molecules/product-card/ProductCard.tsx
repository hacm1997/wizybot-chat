    ...
    return (
        <div className={styles.customBoxShadow + " border border-transparent rounded-lg p-4 shadow w-full bg-amber-50"}>
            <div className="flex gap-4 w-[250px]">
                <img src={product.image} alt={product.name} className="w-[80px] h-[100px] object-cover rounded" loading="lazy" />
                <div className="text-left">
                    ...
                    <p className="text-sm text-black font-semibold">${generateRandomPrice()}</p>
